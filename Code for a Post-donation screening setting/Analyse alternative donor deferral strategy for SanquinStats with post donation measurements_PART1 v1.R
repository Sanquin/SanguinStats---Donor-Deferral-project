...
# Hb      : donor Hb at donation date (numeric) measured post-donation
...
#in this case, Hb is the post-donation Hb measurement (venous), pre_Hb is the capillary pre-donation measurement
